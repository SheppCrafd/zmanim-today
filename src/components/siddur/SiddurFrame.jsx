...
export default function SiddurFrame({ title, subtitle, sourceUrl }) {
  ...
  return (
    <div className="h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-amber-50 flex flex-col">
      ...
      <div className="flex-1 mx-4 mb-4 rounded-xl overflow-hidden shadow-lg border border-slate-200 bg-white">
        {showFallback ? (
          <div className="flex flex-col items-center justify-center h-full py-20 text-center px-6">
            <AlertCircle className="w-10 h-10 text-amber-500 mb-3" />
            <p className="text-slate-700 font-semibold mb-2">
              Unable to load inline
            </p>
            <p className="text-slate-500 text-sm mb-4">
              Sefaria cannot be embedded in this browser. Please open it
              directly.
            </p>
            <a href={sourceUrl} target="_blank" rel="noopener noreferrer">
