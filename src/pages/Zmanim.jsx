...
export default function Zmanim() {
    ...
    const calculateZmanim = async () => {
        ...
        try {
            ...
            const apiUrl = `https://www.hebcal.com/zmanim?cfg=json&latitude=${location.latitude}&longitude=${location.longitude}&date=${dateStr}`;
            ...
            // Extract parsha from events
            const parsha = data.events?.find(e => e.category === 'parashat')?.hebrew || '';
